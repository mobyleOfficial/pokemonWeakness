...
class GrassVMProperties extends PokemonVMProperties {
  @override
  Color get color => PokemonColors.appleGreen;

  @override
  String get iconPath => "assets/images/grass.png";

  @override
  PokemonTypeId get id => PokemonTypeId.grass;

  @override
  String name(BuildContext context) =>
      AppLocalizations.of(context)?.grassName ?? emptyString;
}
