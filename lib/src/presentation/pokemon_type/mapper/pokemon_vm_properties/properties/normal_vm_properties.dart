...
class NormalVMProperties extends PokemonVMProperties {
  @override
  Color get color => PokemonColors.quickSilver;

  @override
  String get iconPath => "assets/images/normal.png";

  @override
  PokemonTypeId get id => PokemonTypeId.normal;

  @override
  String name(BuildContext context) =>
      AppLocalizations.of(context)?.normalName ?? emptyString;
}
