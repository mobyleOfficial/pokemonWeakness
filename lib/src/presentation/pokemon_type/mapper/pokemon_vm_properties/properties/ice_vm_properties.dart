...
class IceVMProperties extends PokemonVMProperties {
  @override
  Color get color => PokemonColors.pearlAqua;

  @override
  String get iconPath => "assets/images/ice.png";

  @override
  PokemonTypeId get id => PokemonTypeId.ice;

  @override
  String name(BuildContext context) =>
      AppLocalizations.of(context)?.iceName ?? emptyString;
}
