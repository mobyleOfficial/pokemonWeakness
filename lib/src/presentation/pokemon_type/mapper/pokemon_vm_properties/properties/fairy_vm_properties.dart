...
class FairyVMProperties extends PokemonVMProperties {
  @override
  Color get color => PokemonColors.lavenderMagenta;

  @override
  String get iconPath => "assets/images/fairy.png";

  @override
  PokemonTypeId get id => PokemonTypeId.fairy;

  @override
  String name(BuildContext context) =>
      AppLocalizations.of(context)?.fairyName ?? emptyString;
}
