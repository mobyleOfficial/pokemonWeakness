...
class WaterVMProperties extends PokemonVMProperties {
  @override
  Color get color => PokemonColors.carolinaBlue;

  @override
  String get iconPath => "assets/images/water.png";

  @override
  PokemonTypeId get id => PokemonTypeId.water;

  @override
  String name(BuildContext context) =>
      AppLocalizations.of(context)?.waterName ?? emptyString;
}
