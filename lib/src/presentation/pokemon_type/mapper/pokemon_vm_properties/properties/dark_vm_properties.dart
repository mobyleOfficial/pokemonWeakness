...
class DarkVMProperties extends PokemonVMProperties {
  @override
  Color get color => PokemonColors.davyGray;

  @override
  String get iconPath => "assets/images/dark.png";

  @override
  PokemonTypeId get id => PokemonTypeId.dark;

  @override
  String name(BuildContext context) =>
      AppLocalizations.of(context)?.darkName ?? emptyString;
}
