...
class GhostVMProperties extends PokemonVMProperties {
  @override
  Color get color => PokemonColors.blueViolet;

  @override
  String get iconPath => "assets/images/ghost.png";

  @override
  PokemonTypeId get id => PokemonTypeId.ghost;

  @override
  String name(BuildContext context) =>
      AppLocalizations.of(context)?.ghostName ?? emptyString;
}
